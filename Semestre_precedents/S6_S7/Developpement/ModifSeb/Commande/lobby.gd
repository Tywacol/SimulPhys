...
func _player_connected(id):
	...
	var pong = load("res://action.tscn").instance()
...
func _end_game(with_error=""):
	if (has_node("/root/Ground")):
		#erase pong scene
		get_node("/root/Ground").free() # erase immediately, otherwise network might show errors (this is why we connected deferred above)
		show()
